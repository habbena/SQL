...
### [peers](https://github.com/habbena/SQL/tree/main/peers)
Проект делался совместно в группе из трех человек в школе разработки от Сбера. 
В рамках проекта: 
- была создана БД с таблицами
- созданы тригеры для корректного заполнения таблиц
- прописаны процедуры со сложными запросами
